<template>
  <div class="threejs-demo-container">
    <div class="threejs-demo-body">
      <div class="demo-layout">
        <div class="demo-list-area">
          <router-link
...
export default class extends Vue {
  private routeOptions = [
    ...
    {
      key: 'MyThreejsDemosHomeDemo35',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo35',
      label: 'demo35',
    },
    {
      key: 'MyThreejsDemosHomeDemo36',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo36',
      label: 'demo36',
    },
    {
      key: 'MyThreejsDemosHomeDemo37',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo37',
      label: 'demo37',
    },
    {
      key: 'MyThreejsDemosHomeDemo38',
    ...
    {
      key: 'MyThreejsDemosHomeDemo40',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo40',
      label: 'demo40',
    },
    {
      key: 'MyThreejsDemosHomeDemo41',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo41',
      label: 'demo41',
    },
    {
      key: 'MyThreejsDemosHomeDemo42',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo42',
      label: 'demo42',
    },
    {
      key: 'MyThreejsDemosHomeDemo43',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo43',
      label: 'demo43',
    },
    {
      key: 'MyThreejsDemosHomeDemo44',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo44',
      label: 'demo44',
    },
    {
      key: 'MyThreejsDemosHomeDemo45',
      path: '/MyThreejsDemos/MyThreejsDemosHome/MyThreejsDemosHomeDemo45',
      label: 'demo45',
    },
  ]
}
